        ...
        $(function(){
           //给搜索按钮绑定单击事件，获取搜索输入框的内容
            $("#search-button").click(function () {
                ...
                location.href="http://localhost:8080/travel/route_list.html?cid=5"+"&rname="+rname;
            });
        });
    </script>
</head>
    ...
    <section id="content">
            ...
            <div class="jx_content">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="popularity">
                        <div class="row">
                            <c:forEach items="${sessionScope.RouteList}" var="route" begin="0" end="3">
                                    <div class="col-md-3">
                    ...
                    <div role="tabpanel" class="tab-pane" id="newest">
                        <div class="row">
                            <c:forEach items="${sessionScope.RouteList}" var="route" begin="4" end="7">
                                <div class="col-md-3">
                                    <a href="<c:url value="getRoutDetail?rid=${route.rid}"/>">
                                        <img src="<c:url value="${route.rimage}"/>" alt="">
                                        <div class="has_border">
                    ...
                    <div role="tabpanel" class="tab-pane" id="theme">
                        <div class="row">
                        <c:forEach items="${sessionScope.RouteList}" var="route" begin="8" end="11">
                            <div class="col-md-3">
                                <a href="<c:url value="getRoutDetail?rid=${route.rid}"/>">
                                    <img src="<c:url value="${route.rimage}"/>" alt="">
                                    <div class="has_border">
        ...
        <section class="hemai_jx">
            ...
            <div class="heima_gn">
                ...
                <div class="guone_r">
                    <div class="row">
                    <c:forEach items="${sessionScope.RouteList}" var="route" begin="12" end="19">
                        <div class="col-md-4">
                            <a href="<c:url value="getRoutDetail?rid=${route.rid}"/>">
								<img src="<c:url value="${route.rimage}"/>" alt="">
								<div class="has_border">
        ...
        <section class="hemai_jx">
            ...
            <div class="heima_gn">
                ...
                <div class="guone_r">
                    <div class="row">
                    <c:forEach items="${sessionScope.RouteList}" var="route" begin="20" end="26">
                        <div class="col-md-4">
                            <a href="<c:url value="getRoutDetail?rid=${route.rid}"/>">
								<img src="<c:url value="${route.rimage}"/>" alt="">
								<div class="has_border">
