...
<div id="header"></div>
    ...
    <div class="wrap">
        <div class="bread_box">
            ...
            <a href="#">${sessionScope.route.rname}</a>
        </div>
        <div class="prosum_box">
            ...
            <div class="prosum_right">
               <p class="pros_title">${sessionScope.route.rname}</p>
                ...
                <div class="pros_price">
                    <p class="price"><strong>${sessionScope.route.price}</strong><span>起</span></p>
                    <p class="collect">
                        <a class="btn" id="collect"><i class="glyphicon glyphicon-heart-empty"></i>点击收藏</a>

                        <a  class="btn already" disabled="disabled" id="cancelCollect"><i class="glyphicon glyphicon-heart-empty"></i>取消收藏</a>
                        <span>已收藏100次</span>
                    </p>
                </div>        
            </div>
        ...
        <div class="you_need_konw">
                <span>旅游介绍</span>
                <div class="notice">
                    ${sessionScope.route.routeIntroduce}
                </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('#collect').on('click',function(){
            ...
            $('#cancelCollect').removeAttr("disabled");
            $.ajax({url:"collect.do",type:"GET",success:function(e){alert('收藏成功');}});
        });

        $('#cancelCollect').on('click',function(){
                    $(this).attr("disabled","disabled");
                    $('#collect').removeAttr("disabled");
                    $.ajax({url:"cancelcollect",type:"GET",success:function(e){alert('取消成功');}});
                });
